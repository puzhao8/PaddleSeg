...
class Encoder(nn.Layer):
    def __init__(self):
        ...
        self.double_conv = nn.Sequential(
            layers.ConvBNReLU(6, 16, 3), layers.ConvBNReLU(16, 16, 3))
        # down_channels = [[64, 128], [128, 256], [256, 512], [512, 512]]
        down_channels = [[16, 32], [32, 64], [64, 128], [128, 128]]
...
class Decoder(nn.Layer):
    def __init__(self, align_corners, use_deconv=False):
        ...
        up_channels = [[128, 64], [64, 32], [32, 16], [16, 16]]
